...
public class App extends Application {
    ...
    private void firstScreen() {
        ...
        Label samplingLabel = new Label("Sampling Frequency");
        TextField samplingField = new TextField();
        Label tempLabel1 = new Label("in Hz");

        fPane3.getChildren().addAll(samplingLabel, samplingField, tempLabel1);
        ...
        vBox1.getChildren().addAll(fPane1, fPane2, fPane3, checkButton);
        ...
        checkButton.setOnAction((event) -> {
            ...
            try {
                samplingFreq = Double.parseDouble(samplingField.getText().toString());
                portFlag = true;
            } catch (NumberFormatException e) {
                Alert alert = new Alert(AlertType.ERROR, "Not a number!",
                        ButtonType.CLOSE, ButtonType.OK);
                alert.show();
                portFlag = false;
            }
    ...
    private void thirdScreen() {
        ...
        convertSeriesToDFT(chart2.getDataSeries(), chart3.getDataSeries());
    ...
    private void fifthScreen(Charts modifiedChart) {
        ...
        convertSeriesToDFT(modifiedChart.getDataSeries(), chart5.getDataSeries());
    ...
    private void saveAsCSV(XYChart.Series<Number, Number> series) {
        ...
        // To choose the name and directory where the file has to be saved
    ...
    // Method which takes two serieses and converts the dataSeries1 to dft and
    // stores the result in dataSeries2
    private void convertSeriesToDFT(XYChart.Series<Number, Number> dataSeries1,
        ...
        Complex[] result = DFT.computeDft(temp, samplingFreq);
